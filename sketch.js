...
var collided = false;
function preload() {
  zombie1 = loadImage("./assets/Gh r1.png");

  zombie2 = loadImage("./assets/Gh r2.png");
  
  sadzombie = loadImage("./assets/Gh 3.png");

  backgroundImage = loadImage("./assets/Bg3.webp");
}
...
function setup() {
  ...
  zombie.addAnimation("righttoleft",  zombie2);
